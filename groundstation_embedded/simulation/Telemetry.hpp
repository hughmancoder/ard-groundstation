...
// Define the TelemetryPacket structure
...
TelemetryPacket sampleData[] = {{3174262, 23.99, 29.63, 99494.90, 153.49, -0.61,
...
inline void printTelemetryAsCSV(const TelemetryPacket &packet) {
    Serial.print(packet.time);
    Serial.print(',');
    Serial.print(packet.bmpTemp, 6);
    Serial.print(',');
    Serial.print(packet.imuTemp, 6);
    Serial.print(',');
    Serial.print(packet.pressure, 2);
    Serial.print(',');
    Serial.print(packet.altitude, 2);
    Serial.print(',');
    Serial.print(packet.accX, 6);
    Serial.print(',');
    Serial.print(packet.accY, 6);
    Serial.print(',');
    Serial.print(packet.accZ, 6);
    Serial.print(',');
